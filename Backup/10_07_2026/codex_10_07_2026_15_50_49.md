...
7. Gera histogramas para:
   ...
   - `addiction_severity`
8. Remove linhas sem `addiction_severity`.
9. Preenche valores ausentes em:
   - `depression_indicator` com a media
   - `subscription_status` com `Unknown`
   - `gpa_or_performance_score` com a moda
